          ...
          <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-2 lg:gap-16">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              <button
                ...
                className="inline-flex items-center justify-center gap-2.5 rounded-2xl bg-white px-5 py-4 text-[15px] font-medium text-ink shadow-[0_8px_24px_-8px_rgba(0,0,0,0.25)] transition-all duration-150 hover:opacity-90 hover:shadow-[0_12px_32px_-8px_rgba(0,0,0,0.3)] active:scale-[0.97] disabled:opacity-60"
              >
