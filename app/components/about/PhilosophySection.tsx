const PILLARS = [
  {
    ...
    count: "01 / 03",
    title: "Patient.",
    body: "We ship when it's ready, not when it's loud. No launch theater, no quarterly desperation, no roadmap-as-marketing.",
  },
  {
    icon: <SearchIcon />,
    count: "02 / 03",
    title: "Careful.",
    body: "Every interaction is examined for noise. We remove before we add. The best feature is often the one we didn't ship.",
  },
  {
    icon: <EyeIcon />,
    count: "03 / 03",
    title: "Strong.",
    body: "Small models, large attention. A quiet team doing serious work. The elephant carries a lot — gently.",
  },
];
